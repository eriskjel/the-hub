...
/**
 * Enumeration of supported widget kinds. The enum is serialized to its string value for JSON.
 */
public enum WidgetKind {
    ...
    /**
     * Parses a string value into a {@link WidgetKind} or throws an {@link IllegalArgumentException} if unsupported.
     */
    @JsonCreator
